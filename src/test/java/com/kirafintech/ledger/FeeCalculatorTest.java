...
class FeeCalculatorTest {
    ...
    private final FeeCalculator calc = new FeeCalculator(1L, 50L); // 1 BPS, $0.50 fixed
    ...
    void northwindFlow_5000Usdc() {
        ...
        assertThat(fees.totalFeeCents()).isEqualTo(100L);    // $1.00 total
        assertThat(fees.netCents()).isEqualTo(499_900L);     // $4,999.00
    ...
    void bpsTruncation_roundsToClientsAdvantage() {
        ...
        assertThat(fees.fixedFeeCents()).isEqualTo(50L);
        assertThat(fees.netCents()).isEqualTo(50L);
    }
}
